...
const lv_footer_privacy = /** @type {(inputs: {}) => LocalizedString} */ () => {
	return /** @type {LocalizedString} */ (`Privātuma politika`)
};

const en_footer_privacy = /** @type {(inputs: {}) => LocalizedString} */ () => {
...
export const footer_privacy = (inputs = {}, options = {}) => {
	...
	if (locale === "lv") return lv_footer_privacy(inputs)
	return en_footer_privacy(inputs)
};